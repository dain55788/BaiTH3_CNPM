...
if __name__ == '__main__':
    with app.app_context():
        ...
        u = User(name="admin", username="admin", password=str(hashlib.md5("123456".encode('utf-8')).hexdigest()),
                 avatar="https://resizing.flixster.com/Cn9p9WyhLBe3B2dxKKfaE1N57XE=/fit-in/352x330/v2/https://resizing.flixster.com/-XZAfHZM39UwaGJIFWKAE8fS0ak=/v3/t/assets/p13937884_v_v13_aa.jpg",
